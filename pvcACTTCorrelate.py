...
parser = argparse.ArgumentParser(description='Compute average correlation between reconstructed and true activation times .')
...
gt_potentials_array  = ground_truth_dict['acttimes_GT']
...
sol_potentials_array  = solution_dict['acttimes']
